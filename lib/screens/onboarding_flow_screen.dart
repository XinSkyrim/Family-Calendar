...
class _OnboardingFlowScreenState extends State<OnboardingFlowScreen> {
  ...
  static const List<_StepCopy> _steps = [
    ...
    _StepCopy(
      ...
      description:
          'Tap the note button at the bottom to create a text memo for your family reminders.',
      nextLabel: 'Show voice memo',
      page: _OnboardingPage.memo,
    ),
    _StepCopy(
      key: 'memo_voice',
      ...
      description:
          'Tap the microphone button to record voice memos when typing is inconvenient.',
    ...
    _StepCopy(
      ...
      description:
          'Your shared events appear here. Use this page to coordinate family schedules.',
      nextLabel: 'Show date selector',
    ...
    _StepCopy(
      ...
      description:
          'Use the horizontal date selector to view events for different days.',
      nextLabel: 'Show add task',
      page: _OnboardingPage.calendar,
    ),
    _StepCopy(
      key: 'calendar_add',
      ...
      description:
          'Tap the + button to create a family event. You can set date, time, and participants.',
